...
public interface User {
    ...
    /**
     * Устанавливает уникальный идентификатор группировки пользователя
     * @param id Уникальный идентификатор группировки пользователя
     * @return Текущий пользователь
     */
    public User setGroupId(long id);
    ...
    /**
     * Возвращает уникальный идентификатор группировки пользователя
     * @return Уникальный идентификатор группировки пользователя
     */
